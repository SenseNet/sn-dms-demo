...
interface GroupSelectorToolbarProps {
...
class GroupSelectorToolbar extends React.Component<{ classes } & ReturnType<typeof mapStateToProps> & GroupSelectorToolbarProps, {}> {
    public handleClick = () => {
...
export default connect(mapStateToProps)(withStyles(styles)(GroupSelectorToolbar))
